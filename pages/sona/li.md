...
I do say "any word", but clever observers will have noticed I am treating the
word [li]{.tokipona} differently. It is introduced as a particle, its definition
is given in parentheses, and it is treated as a grammatical structure instead of
as a word. This is because [li]{.tokipona} cannot be used in the subject or
predicate, with some subtle exceptions we'll get to later. For now, everything
_else_ can be in the subject or predicate.
...
Using more than one [li]{.tokipona} is the same as using two sentences with the
