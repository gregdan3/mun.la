...
- [How to do better](#how-to-do-better)
  - [Event Running is easier than you think](#event-running-is-easier-than-you-think)
  - [Speaking Toki Pona is easier than you think](#speaking-toki-pona-is-easier-than-you-think)
  - ["Only Toki Pona" is more flexible than you think](#only-toki-pona-is-more-flexible-than-you-think)
- [Questions and Clarifications](#questions-and-clarifications)
  - [What if my event is for learners?](#what-if-my-event-is-for-learners)
  - [Why does it need to be **only** toki pona?](#why-does-it-need-to-be-only-toki-pona)
  - [Does the **entire** event need to be only toki pona?](#does-the-entire-event-need-to-be-only-toki-pona)
...
- **Nobody wants to be excluded!** If you make a space or event which only
  ...
  feeling unconfident, unskilled, or uninvited.

[^mapona]:
    [ma pona pi toki pona]{.tp} has actually had huge success in getting people
    to speak toki pona. There isn't one clear cause, but I'd most attribute this
    most to the space now (as of May 2024) offering specific topics for
    conversations in its design. That said, there are still some failure points-
    I've only observed it in the general chat, but some members of the server
    push back on the idea of speaking toki pona literally ever. Buuuut, once the
    general chat calmed down for a while, those present would routinely speak
    toki pona in the channel!

<!--reinforcing the pressure to speak English. Unless specific steps are taken to-->
<!--create spaces and events for toki pona speakers, almost everyone who shows up is-->
<!--going to speak English and not toki pona- and this makes every event into a de-->
<!--facto learner event!-->

To address the above, we should first delineate which of these are solvable
problems, and which are unsolvable.

- **We cannot help the fact that communities and languages only facilitate
  conversation.** Talking about toki pona is extremely fun, but it isn't to
  everyone's taste, and it only goes so far. After that, you need something new
  to talk about.
- **We cannot help the fact that most of the community is learners.** toki pona
  is fascinating to the right type of person, and we draw in that sort of person
  all the time! The reality is, the community's skilled speakers may _always_ be
  outnumbered by new learners, and there is only so much we can do to close that
  gap with education.

- **We can help the fact that most of the community speaks English**, but that
  is not my focus for this article. I do briefly discuss the issue and how to
  address it in this footnote[^english-speakers], but I believe the other
  problems are either more important to solve first or lead to helping this
  anyway.
- **We can help the fact that running events is hard.** Events do not _have_ to
  be hard- we just have to plan simpler events. I've personally run several
  events in [ma pona pi toki pona]{.tp}, and dozens in [ma toki pona
  [wile.jan.]]{.tp}- the former is exhausting and prone to error, while the
  latter is comfortable and easy. In my opinion, the difference is in
  preparation, expectation, and help.
- **We can help people to not feel excluded**, up to a point. Events can be
  designed in such a way that, even though they are "toki pona only," they can
  be accessible to learners- not only to listen to, but to participate in! We
  can't bridge this gap for everyone, but we can absolutely do better.

[english-speakers]: It would take a long time and a lot of effort to change the
fact that most of the community speaks English- it's also possible this literal
fact will never change. But its consequences could change. The reason the
community is primarily English speaking is that most resources for learning toki
pona are in English, and most of the community is English speaking. Changing
this would mean creating more learning materials in languages other than
English, and discouraging English from use- which can at least be done with toki
pona itself!

Given all of this, do you think we could run **more, better, and easier events**
which **require toki pona** but are still **accessible to learners?**

## How to do better

### Event Running is easier than you think

There is an instinct to be massively over-prepared for running an event. Newbies
to event running often want to get lists of every participant, put them into an
exact order, know what they're doing ahead of time, create tons of advertising
materials, and even plan the entire _next_ entire event in advance.

It is true that you need to be prepared to run an event, but you'd be surprised
at how little you _need_ in order to be ready! For most purposes, these are your
only _necessary_ responsibilities:

- Have something to do during the event!
- Choose what day and time the event starts!
- Remind everyone that the event is coming up to build hype!
- Be present during the event to make sure things run smoothly!

And then you have a few _optional_ responsibilities:

- Start with something exciting!
- End with something exciting!
- Have an incentive for participating, like a contest with rewards or an
...
### "Only Toki Pona" is more flexible than you think

There is a reflex from especially skilled and invested speakers of Toki Pona to
seriously over-correct, enforcing that only Toki Pona is used for entire events
or communities. It is their prerogative to do so, and I respect the effort- Toki
Pona is capable of any conversation you need it for, and we should not
artifically limit it out of a mistaken belief that Toki Pona _isn't_ capable.

However, we need to be realistic on this point: Just because _you personally_
can use toki pona to express anything, does not mean everyone else can do so- a
huge number of people in the community are in the learning process, and will
still need help

To encourage people to speak toki pona, you should **use English as a tool** to
advertise events, create hype, and share excitement. Then, once that's done,
**speak only toki pona** for the entire event! This way, you cast **as wide a
net as possible** for your target audience, bringing in interested people who
may not be confident enough in their toki pona skill to follow the announcement.

And to be clear: the event **has to be only toki pona**! But that line is
malleable- you can keep casting a wide net by making a space where other
languages can be spoken while the main event remains only toki pona. Discord
voice chats are a great example of this, since the voice chat can be in toki
pona while the text chat is in English for learners to ask questions.

<!--If you speak Toki Pona and you're growing an existing community, making a new community, or planning events and outreach, **use English** to advertise events, create hype, share excitement, and otherwise interest people in speaking Toki Pona! Once that's done, speak **only toki pona** all the rest of the time- don't let your hype go to waste!-->

<!-- - it's okay to speak English as a means to -->
<!-- don't let English steal good topics from toki pona! -->

<!--Put another way, English should be used as a _tool_ to create opportunities to-->
<!--learn and speak Toki Pona.-->
...
<!--But if all you wanted was the advice from the headline, you're good to go! The-->
<!--rest of this article is the is the collected observations of myself and others,-->
<!--and how those lead me to offer the above advice. Enjoy!-->

## Questions and Clarifications

### What if my event is for learners?

Do what you want! I have thoughts about how best to design an event for totally
new learners, but the focus of this article is creating opportunities to speak
toki pona at an intermediate and advanced level.

### Why does it need to be **only** toki pona?

There are a few other ways that the toki pona community organizes events.
Summarizing them:

- Just an event, without any specific language required.
-

### Does the **entire** event need to be only toki pona?
...
There are plenty of spaces which only allow toki pona, or at least cordon off
English to a small corner of the space, but these tend to lack focus, activity,
or even participants in many cases.
...
But if we consider a space to be successful because it encourages the most _use_
of Toki Pona, these much larger English-first spaces are still the most
...
English, none of you will ever end up having that discussion in Toki Pona later.
After all, why would you? Reiterating the initial conversation would be akin to
a translation exercise- not a conversation unto itself. That's great for
learners, but often boring for experienced speakers!

Every conversation in English, especially those which study toki pona, takes
away a discussion that could have been in toki pona. This isn't to say that
_every_ conversation needs to be in toki pona- but many that could _easily_ be
in toki pona are not.

A common example would be conversations that study Toki Pona. Broadly speaking,
most conversations _about_ toki pona are to study it. This is true for both
learners and experienced speakers, where learners are using a language they
already know to study toki pona, and experienced speakers are discussing
specific ways they and others use toki pona... in English. While learners are
([mostly](https://www.youtube.com/playlist?list=PLwYL9_SRAk8EXSZPSTm9lm2kD_Z1RzUgm))
off the hook for using English to learn, experienced speakers have no excuse!
...
The trouble is that there are _so many_ conversations about Toki Pona which are
not _in_ it, to the point that several turns of phrase have developed to refer
to these conversations, such as the phrase "nasin discussion."

### The community wants more toki pona

Within the community, there are many speakers who want more opportunities to
speak toki pona. There are frequent complaints about English entirely consuming
conversations, and about being ignored when attempting to speak toki pona in a
conversation that is currently primarily in English.

To those who joined the community to speak toki pona, this is deeply
frustrating. It is

This is especially true of toki pona's most invested speakers, who love the
language dearly. Both of these groups would like to use toki pona in new ways,
to explore what it is capable of, and challenge themselves to learn more about
new topics in new conversations- among any number of other personal motivations
for speaking toki pona. But opportunities to actually explore the boundaries of
toki pona do not come up often.
...
This is an issue that the community and its members frequently run into. I've
seen easily dozens of independent realizations of this fact.
...
<!---->
<!-- This is a quote from jan Olipija, who happen to discuss this topic with jan -->
<!-- Lakuse and jan Tepo a few days before I had a very similar conversation with -->
<!-- kala Asi. It was pretty funny to find! -->
<!---->
<!-- In reading, we're on a similar page about the challenges toki pona has faced in -->
<!-- being its own language and having its own identity, but I don't fully agree with -->
<!-- her diagnosis. -->
<!---->
<!-- If I understood her correctly, her imagining of a future toki pona community is -->
<!-- primarily bi-lingual -->
<!---->
